  ...
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
      <section class="news_container">
        <div class="inner">
          ...
          <?php endif; ?>
          <div class="news_txt single-body">
            <div class="blog-detail__body">
              <div class="blog-content"><?php echo the_content(); ?></div>
            </div>
          </div>
          <div class="for_news">
            <a class="cmn-button for-news-button" href="<?php echo esc_url(home_url()); ?>/category/training/">新着情報一覧<span class="arrow-right-l icon"></span></a>
          </div>
        </div>
      </section>
  <?php endwhile;
