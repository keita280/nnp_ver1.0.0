...
<head>
  ...
  <?php if (is_category() ) : ?>
    <!-- タイトルを指定 -->
    <meta name="title" content="一般社団法人全国精神科栄養士協会｜新着情報">
    <!-- ディスクリプションを指定 -->
    <meta name="description" content="研修案内や活動報告など、最新の情報をお知らせしています。">
  <?php endif; ?>

<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-LDCP7YLER5"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'G-LDCP7YLER5');
</script>
    ...
    <div class="header_inner">
      ...
      <nav class="header_bottom is-pc">
        <ul class="header_bottom_menu">
          ...
          <li class="header_bottom_list">
            <a class="header_bottom_link" href="<?php echo esc_url(home_url()); ?>/category/training/">新着情報</a>
          </li>
          <li class="header_bottom_list">
